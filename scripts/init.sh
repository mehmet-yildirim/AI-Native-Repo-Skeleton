...
#   bash scripts/init.sh --non-interactive   # use env vars (for CI)
# =============================================================================
...
# Generated by scripts/init.sh — do not edit manually; re-run init.sh to update
# =============================================================================
project:
  name: "${PROJECT_NAME}"
  slug: "${PROJECT_SLUG}"
...
echo ""
echo -e "${CYAN}Then validate: bash scripts/validate-ai-config.sh${NC}"
echo ""

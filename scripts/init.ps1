...
#
# Usage:
#   .\scripts\init.ps1                     # interactive mode
#   .\scripts\init.ps1 -NonInteractive     # use environment variables (for CI)
#
...
# Generated by scripts/init.ps1 -- do not edit manually; re-run init.ps1 to update
# =============================================================================
project:
  name: "$PROJECT_NAME"
  slug: "$PROJECT_SLUG"
...
Write-Host ""
Write-Host "Then validate: .\scripts\validate-ai-config.ps1" -ForegroundColor Cyan
Write-Host ""

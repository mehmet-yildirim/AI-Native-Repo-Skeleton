...
if ($missingConfig) {
    Write-Warn "Some AI config files are missing. Run: .\scripts\validate-ai-config.ps1"
}
...
Write-Host "  * Validate: .\scripts\validate-ai-config.ps1"

...
:: (Windows Batch)
:: =============================================================================
:: Run this after setup.bat to configure your project's mechanical settings.
...
echo # Generated by scripts/init.bat -- do not edit manually; re-run init.bat to update
echo # =============================================================================
echo project:
...
echo.
echo Then validate: scripts\validate-ai-config.bat
echo.
goto :eof

...
Read any referenced documents, existing code, or context files before producing output.
...
Order tasks by dependency. Flag any that require further design (use `/architect` on those).

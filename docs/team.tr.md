...
- Takıma sunmadan önce iskelet güncellemelerini inceler ve test eder
...
- İskeleti, MCP sunucularını ve ajan altyapısını sahiplenen bir **platform alt takımı** (1–2 kişi) oluşturun
...
2. **1. Gün — AI araç kurulumu:** Claude Code'u yüklemek, Cursor veya Continue'yu yapılandırmak için `docs/onboarding.tr.md`'yi takip edin. `bash scripts/validate-ai-config.sh` ile doğrulayın.

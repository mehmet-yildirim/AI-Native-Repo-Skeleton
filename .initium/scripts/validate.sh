...
check_exists "docs/guides/agent/autonomous-workflow.md"
check_exists "docs/guides/agent/escalation-protocol.md"
check_exists "docs/guides/agent/decision-log-template.md"
check_exists "docs/guides/agent/jira-server-setup.md"
check_exists "docs/guides/agent/documentation-agent.md"
...
check_exists "docs/guides/agent/schemas/task-state.json"
check_exists "docs/guides/agent/schemas/decision.json"
check_exists "docs/guides/agent/schemas/requirement-analysis.json"
check_exists "docs/guides/agent/schemas/qa-report.json"
...
check_exists "docs/guides/agent/security-evaluator.md"
check_exists "docs/guides/agent/schemas/security-report.json"

...
Check-Exists "docs/guides/agent/autonomous-workflow.md"
Check-Exists "docs/guides/agent/escalation-protocol.md"
Check-Exists "docs/guides/agent/decision-log-template.md"
Check-Exists "docs/guides/agent/jira-server-setup.md"
Check-Exists "docs/guides/agent/security-evaluator.md"
Check-Exists ".agent-templates/webhook-receiver.mjs"
Check-Exists "docs/guides/agent/schemas/task-state.json"
Check-Exists "docs/guides/agent/schemas/decision.json"
Check-Exists "docs/guides/agent/schemas/requirement-analysis.json"
Check-Exists "docs/guides/agent/schemas/qa-report.json"
Check-Exists "docs/guides/agent/schemas/security-report.json"

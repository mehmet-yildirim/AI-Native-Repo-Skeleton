Plan and execute a database migration safely. This prompt covers schema design, migration file generation, rollback strategy, and production deployment guidance.

Reference existing schema files, ORM models, and migration history before proceeding.

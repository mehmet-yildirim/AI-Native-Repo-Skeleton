...
- Proceed to `@.cursor/prompts/requirements.md`

**If REJECT:**
- Add comment to the issue: "This issue is outside this project's domain. [Reasoning]. Suggested: [redirect]."
...
- Add comment with available actions: AGENT_RESUME to accept, AGENT_REJECT to decline

---

**Issue to triage** (paste issue ID, title, and description):
